...
#define CONFIG_STM32_USART_PORT		1	/* USART3 */
#define CONFIG_STM32_USART_TX_IO_PORT	0	/* PORTC */
#define CONFIG_STM32_USART_RX_IO_PORT	0	/* PORTC */
#define CONFIG_STM32_USART_TX_IO_PIN	9	/* GPIO10 */
#define CONFIG_STM32_USART_RX_IO_PIN	10	/* GPIO11 */
...
#define CONFIG_BOOTARGS			"stm32_platform=stm32429-disco mem=8M "\
							"console=ttyS0,115200n8 consoleblank=0 "\
